...
let g:im_mode_insert = 1033

autocmd InsertEnter * silent! execute "!im-select.exe " . g:im_mode_insert
func! StoreIMAndSwitchEnglish()
    let g:im_mode_insert = system("im-select.exe")
    silent! execute "!im-select.exe 1033"
endfunc
autocmd InsertLeave * call StoreIMAndSwitchEnglish()
